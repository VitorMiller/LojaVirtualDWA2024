...
async def inserir_produto(
    ...
    descricao: str = Form(...),
    estoque: int = Form(...),
    imagem: Optional[UploadFile] = File(None) ,)->Produto:

    novo_produto = InserirProdutoDto(
        nome=nome,
        preco=preco,
        descricao=descricao,
        estoque=estoque
    ...
    await asyncio.sleep(SLEEP_TIME)
    novo_produto = Produto(None, novo_produto.nome, novo_produto.preco, novo_produto.descricao, novo_produto.estoque)
